!
  function (e, t) {
    ...
    var B, F, L, I, j, q, W, Y, Z, K, $, G, J, Q, X, i = "ScrollSmoother",
      ...
      r = (function (e) {
        ...
        return F || (B = e || t(), s() && window.document && (L = window, I = document, j = I.documentElement, q = I.body), B && (W = B.utils.toArray, Y = B.utils.clamp, $ = B.parseEase("expo"), Q = B.core.context ||
          function () { }, Z = B.core.globals().ScrollTrigger, B.core.globals("ScrollSmoother", ScrollSmoother), q && Z && (X = B.delayedCall(.2, function () {
    ...
    r.version = "3.12.5", r.create = function (e) {
      ...
      return K
    }, t() && B.registerPlugin(r), e.ScrollSmoother = r, e.
      default = r;
